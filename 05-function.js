...
function checkBMI() {
	...
	if (bmi < 18.5) {
		...
		keterangan = "extremely obese";
	}
	return bmi = ("Hasil perhitungan BMI : " + bmi.toFixed(1));
}
...
console.log(convToUpperCase('semangat terus '));
...
function firstNonRepeatedChar(word) {
 ...
 console.log(firstNonRepeatedChar("semangattt :)"));
